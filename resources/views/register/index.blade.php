    ...
    <div class="col-lg-5">
      ...
      <div class="row justify-content-center">
        ...
        <main class="form-registration w-100 m-auto">
          ...
          <h3 class="h3 mb-3 fw-bold text-center">Halaman Registrasi</h3>
            ...
            <small class="d-block text-center mt-3 mb-5">Sudah punya akun ? <a href="/login"> Login disini</a></small>
          </main>
    </div>
</div>
@endsection